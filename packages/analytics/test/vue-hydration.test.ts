...
import type { AnalyticsSeriesReport } from '../src'
import { AnalyticsAreaChart, AnalyticsLineChart } from '../src/vue-ui-entry'
...
describe('Vue chart hydration', () => {
    ...
    it('hydrates server-rendered line and area SVGs without warnings', async () => {
        ...
        const Root = () =>
            h('main', [
                h(AnalyticsLineChart, { report, title: 'Line' }),
                h(AnalyticsAreaChart, { report, title: 'Area' }),
            ])
